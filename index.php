...
<html lang="en">
  ...
  ?>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('img/shumqena.jpg');">
      ...
      <div class="slider-item" style="background-image: url('img/1qen.jpg');">
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 element-animate">
              <h1>Care for dogs</h1>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          ...
          <div class="col-md-8 section-heading">
            ...
            <p class="small-sub-heading">Breed of the month</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-4">
            <p>The German Shepherd is a large breed dog, and they can continue to mature up until they reach 36 months. However, they can be fully considered as an adult GSD or a full grown GSD until the male is already 2 ½ years and the female reaches two years or more.</p>
          </div>
        </div>
      </div>
    </section>
